...
PieChart(sexo, data = uso_tiempo, hole = 0, values = "%", ,      
         fill = c("blue", "violet","orange"), main = "Distribución porcentual según sexo") 
...
summarise(mean(trabajo_pago2),mean(trabajo_domestico_no_pago2),mean(tareas_cuidados2), mean(voluntariados2))|>
